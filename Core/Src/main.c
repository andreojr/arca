...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, NFC_NSS_Pin|NSS_TEMP_Pin|NSS_CC1101_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : NFC_NSS_Pin NSS_TEMP_Pin NSS_CC1101_Pin */
  GPIO_InitStruct.Pin = NFC_NSS_Pin|NSS_TEMP_Pin|NSS_CC1101_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
{
  #if FEATURE_NFC
  if (GPIO_Pin == NFC_INT_Pin) NFC_Module_IRQ();
  #endif
}
/* USER CODE END 4 */
